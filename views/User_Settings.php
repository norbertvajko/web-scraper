    ...
    <div class="container main-user-cont">
        <main class="main-results">
            <section class="user-account-content user-account-security">
                ...
                include "../views/components/verifyPasswordPopUp.php";
                            ...
                            <div>
                                <div class="uas-setting-details">
                                    ...
                                    <div class="uas-setting-actions">
                                        ...
                                        <button class="btn btn-primary" id="modifyEmailB" onclick="showResetPassPopUp();" > modifică</button>
                                    </div>
                                </div>
                                <div class="uas-setting uas-setting-password">
                                    <div>
                                        <div class="uas-setting-details">
                                            ...
                                            <div class="uas-setting-actions">
                                                <a href="#" class="btn btn-primary">modifică</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php
                                    ...
                                    <p>You have to be logged in in order to change your email</p>
