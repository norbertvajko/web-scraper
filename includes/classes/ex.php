...
class buildProduct extends Product implements productParts
{
    ...
    public function setStock($inStock)
    {
        $this->inStock = $inStock;
    }
    ...
    public function productDescription()
    {
        ...
        return "produsele sunt dsadas dasl ma d";
...
class tuningProduct extends buildProduct implements productParts
{

    public function __construct($name, $price, $image, $reviews, $inStock)
    {
        parent::__construct($name, $price, $image, $reviews, $inStock);
    }
    ...
    public function productDescription()
    {
       return parent::productDescription(); // TODO: Change the autogenerated stub
    }
...
class Util
{
    public static function switchCaseOfWords($text, $case)
    {
            switch ($case) {
                case 0:
                    $text = ucfirst($text);
